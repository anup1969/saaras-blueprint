import{r as s,R as f,j as e,a1 as y}from"./index-B0HXAnM_.js";import{W as J}from"./WithLabelCode-Cq3iEGQw.js";import{C as h}from"./CodeDialog-C1N4vVlG.js";import{$ as Q,a as ee}from"./useFocusRing-Cf8l_oKM.js";import{w as re}from"./use-active-press-Dxcia4TV.js";import{l as ne,b as se}from"./use-default-value-CVa_OQbn.js";import{Y as ae,p as te,o as g,V as ie,a as oe,K as ce}from"./render-wzWQcPy5.js";import{a as de}from"./disabled-Cmc0bqKc.js";import{j as le,g as he,W as a}from"./field-0YNh-R2m.js";import{u as xe,N as pe,Z as t}from"./label-z49PO6XA.js";import{s as me}from"./bugs-BJ7ScNGK.js";import{w as be,M as ue}from"./description-D5Wtlf8n.js";import{o as w}from"./keyboard-C1Wiwm26.js";import{C as x}from"./card-Cg1w-DhQ.js";import{C as W}from"./CardBox-DnrW3_OL.js";import{B as ke}from"./BreadcrumbComp-9UXnI3U7.js";import"./index-BfJfxS1b.js";import"./vsc-dark-plus-C_odMC5h.js";import"./highlight-hCPzqiPq.js";import"./toConsumableArray-Cia6afFk.js";import"./unsupportedIterableToArray-SCsxY82q.js";import"./defineProperty-M-z99tId.js";import"./extends-CF3RwP-h.js";import"./owner-DrGvqvJ-.js";import"./hidden-CXVWdIK3.js";import"./use-sync-refs-DQhvWRpV.js";import"./dom-BlW_0b_t.js";import"./chevron-right-CYEh_jNb.js";import"./createLucideIcon-9FnylcZ7.js";let ge="span";function je(r,n){let o=s.useId(),c=xe(),p=de(),{id:m=c||`headlessui-checkbox-${o}`,disabled:l=p||!1,autoFocus:v=!1,checked:E,defaultChecked:F,onChange:S,name:N,value:B,form:M,indeterminate:j=!1,tabIndex:D=0,...T}=r,b=ne(F),[k,u]=se(E,S,b??!1),$=pe(),U=be(),H=te(),[P,L]=s.useState(!1),C=g(()=>{L(!0),u==null||u(!k),H.nextFrame(()=>{L(!1)})}),R=g(d=>{if(me(d.currentTarget))return d.preventDefault();d.preventDefault(),C()}),A=g(d=>{d.key===w.Space?(d.preventDefault(),C()):d.key===w.Enter&&he(d.currentTarget)}),K=g(d=>d.preventDefault()),{isFocusVisible:z,focusProps:I}=Q({autoFocus:v}),{isHovered:V,hoverProps:G}=ee({isDisabled:l}),{pressed:O,pressProps:X}=re({disabled:l}),Y=ie({ref:n,id:m,role:"checkbox","aria-checked":j?"mixed":k?"true":"false","aria-labelledby":$,"aria-describedby":U,"aria-disabled":l?!0:void 0,indeterminate:j?"true":void 0,tabIndex:l?void 0:D,onKeyUp:l?void 0:A,onKeyPress:l?void 0:K,onClick:l?void 0:R},I,G,X),Z=oe({checked:k,disabled:l,hover:V,focus:z,active:O,indeterminate:j,changing:P,autofocus:v}),_=s.useCallback(()=>{if(b!==void 0)return u==null?void 0:u(b)},[u,b]),q=ce();return f.createElement(f.Fragment,null,N!=null&&f.createElement(le,{disabled:l,data:{[N]:B||"on"},overrides:{type:"checkbox",checked:k},form:M,onReset:_}),q({ourProps:Y,theirProps:T,slot:Z,defaultTag:ge,name:"Checkbox"}))}let i=ae(je);const fe=`import { useState } from 'react'\r
