import{r as s,R as f,j as e,a1 as y}from"./index-hJ2SD4IE.js";import{W as J}from"./WithLabelCode-Cq3iEGQw.js";import{C as h}from"./CodeDialog-BfgoSlBj.js";import{$ as Q,a as ee}from"./useFocusRing-BV3_HsUU.js";import{w as re}from"./use-active-press-DRsr-MUW.js";import{l as ne,b as se}from"./use-default-value-8O9uB1_Q.js";import{Y as ae,p as te,o as g,V as ie,a as oe,K as ce}from"./render-D4HeI6Nr.js";import{a as de}from"./disabled-CuDhUv8O.js";import{j as le,g as he,W as a}from"./field-hecxh0Wm.js";import{u as xe,N as pe,Z as t}from"./label-C8OIUv8U.js";import{s as me}from"./bugs-BJ7ScNGK.js";import{w as be,M as ue}from"./description-GQA3je54.js";import{o as w}from"./keyboard-C1Wiwm26.js";import{C as x}from"./card-lwgsVE9g.js";import{C as W}from"./CardBox-B317o365.js";import{B as ke}from"./BreadcrumbComp-O0ZCyfoZ.js";import"./index-u1GrS9Dt.js";import"./vsc-dark-plus-BS5XCmWA.js";import"./highlight-C_eLAOnJ.js";import"./toConsumableArray-Cia6afFk.js";import"./unsupportedIterableToArray-SCsxY82q.js";import"./defineProperty-M-z99tId.js";import"./extends-CF3RwP-h.js";import"./owner-Bbldmi17.js";import"./hidden-TglnW24O.js";import"./use-sync-refs-DDif7ltm.js";import"./dom-BlW_0b_t.js";import"./chevron-right-Dqa42BwH.js";import"./createLucideIcon-sKS6wsf3.js";let ge="span";function je(r,n){let o=s.useId(),c=xe(),p=de(),{id:m=c||`headlessui-checkbox-${o}`,disabled:l=p||!1,autoFocus:v=!1,checked:E,defaultChecked:F,onChange:S,name:N,value:B,form:M,indeterminate:j=!1,tabIndex:D=0,...T}=r,b=ne(F),[k,u]=se(E,S,b??!1),$=pe(),U=be(),H=te(),[P,L]=s.useState(!1),C=g(()=>{L(!0),u==null||u(!k),H.nextFrame(()=>{L(!1)})}),R=g(d=>{if(me(d.currentTarget))return d.preventDefault();d.preventDefault(),C()}),A=g(d=>{d.key===w.Space?(d.preventDefault(),C()):d.key===w.Enter&&he(d.currentTarget)}),K=g(d=>d.preventDefault()),{isFocusVisible:z,focusProps:I}=Q({autoFocus:v}),{isHovered:V,hoverProps:G}=ee({isDisabled:l}),{pressed:O,pressProps:X}=re({disabled:l}),Y=ie({ref:n,id:m,role:"checkbox","aria-checked":j?"mixed":k?"true":"false","aria-labelledby":$,"aria-describedby":U,"aria-disabled":l?!0:void 0,indeterminate:j?"true":void 0,tabIndex:l?void 0:D,onKeyUp:l?void 0:A,onKeyPress:l?void 0:K,onClick:l?void 0:R},I,G,X),Z=oe({checked:k,disabled:l,hover:V,focus:z,active:O,indeterminate:j,changing:P,autofocus:v}),_=s.useCallback(()=>{if(b!==void 0)return u==null?void 0:u(b)},[u,b]),q=ce();return f.createElement(f.Fragment,null,N!=null&&f.createElement(le,{disabled:l,data:{[N]:B||"on"},overrides:{type:"checkbox",checked:k},form:M,onReset:_}),q({ourProps:Y,theirProps:T,slot:Z,defaultTag:ge,name:"Checkbox"}))}let i=ae(je);const fe=`import { useState } from 'react'\r
