...
type TabId = 'categories' | 'storage' | 'distribution';

export default function DocumentMgmtConfigModule({ theme, activeTab: externalTab, onTabChange }: { theme: Theme; activeTab?: string; onTabChange?: (tab: string) => void }) {
  ...
  const [internalTab, setInternalTab] = useState<TabId>('categories');
