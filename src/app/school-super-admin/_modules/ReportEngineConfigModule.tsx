...
export default function ReportEngineConfigModule({ theme }: { theme: Theme }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── 1. Scheduled Reports Master Table ──────── */}
      ...
      {/* ── 4. Email Reports (existing toggle) ──────── */}
      ...
      {/* ── 5. Export Formats + Report Recipients ───── */}
      ...
      {/* ── 6. Auto-Generate Reports (existing) ─────── */}
