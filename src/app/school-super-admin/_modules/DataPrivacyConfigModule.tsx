...
type TabId = 'consent' | 'compliance' | 'security';

export default function DataPrivacyConfigModule({ theme, activeTab: externalTab, onTabChange }: { theme: Theme; activeTab?: string; onTabChange?: (tab: string) => void }) {
