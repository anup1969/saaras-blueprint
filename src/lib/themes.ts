...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    primary: 'bg-rose-400', primaryText: 'text-rose-500',
    secondaryBg: 'bg-rose-50', accentBg: 'bg-rose-50',
    border: 'border-rose-200', sidebarBg: 'bg-white',
    highlight: 'text-rose-900', cardBg: 'bg-white',
    iconColor: 'text-rose-300', buttonHover: 'hover:bg-rose-50',
    inputBg: 'bg-white', helpBtn: 'bg-rose-50 text-rose-500',
    bodyBg: 'bg-gradient-to-br from-rose-50 via-pink-50 to-fuchsia-50',
  },
];
