...
export const stakeholders = [
  ...
  { id: 'principal', name: 'Principal', icon: 'GraduationCap', desc: 'Academic oversight, SQAAF compliance, timetable, MIS reports', phase: 1, status: 'planned' },
  { id: 'teacher', name: 'Teacher', icon: 'BookOpen', desc: 'Attendance, homework, assignments, class management', phase: 1, status: 'planned' },
  { id: 'student', name: 'Student', icon: 'User', desc: 'Self-service portal — homework, results, fees, timetable', phase: 1, status: 'planned' },
  { id: 'parent', name: 'Parent', icon: 'Users', desc: 'Child monitoring, fees, communication, pickup', phase: 1, status: 'planned' },
  { id: 'super-admin', name: 'Super Admin', icon: 'Shield', desc: 'Platform management — schools, subscriptions, onboarding', phase: 1, status: 'planned' },
  { id: 'trustee', name: 'Trustee', icon: 'Eye', desc: 'Governance view — SQAAF, financial summaries, compliance', phase: 1, status: 'planned' },
  { id: 'vice-principal', name: 'Vice Principal', icon: 'UserCheck', desc: 'Operational management, substitutions, discipline', phase: 1, status: 'planned' },
  { id: 'hr-manager', name: 'HR Manager', icon: 'Briefcase', desc: 'Employee lifecycle, attendance, leaves, payroll', phase: 1, status: 'planned' },
  { id: 'accounts-head', name: 'Accounts Head', icon: 'Calculator', desc: 'Fee collection, financial reports, concessions', phase: 1, status: 'planned' },
  { id: 'receptionist', name: 'Receptionist', icon: 'Phone', desc: 'Front office — visitors, enquiries, calls', phase: 1, status: 'planned' },
  { id: 'transport-head', name: 'Transport Head', icon: 'Bus', desc: 'Routes, vehicles, GPS tracking, drivers', phase: 1, status: 'planned' },
  { id: 'security', name: 'Security / Gatekeeper', icon: 'ShieldCheck', desc: 'Visitor check-in, student pickup, gate management', phase: 1, status: 'planned' },
  { id: 'account-manager', name: 'Account Manager', icon: 'Headphones', desc: 'Company-side support for assigned schools', phase: 1, status: 'planned' },
];
